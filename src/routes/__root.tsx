...
const APP_NAME = "Kendra — SwiftRoute Knowledge";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "apple-mobile-web-app-title", content: "Kendra" },
      { name: "theme-color", content: "#0c0d0b" },
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "description",
        content: "Permission-aware, citation-first knowledge for SwiftRoute field teams.",
      },
      ...(ogImage
        ? [
